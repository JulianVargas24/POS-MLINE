...
class TablaProductosVentasExentas{


	public function mostrarTablaProductosVentasExentas(){
    	...
    	$orden = "id";
		  ...
		  "data": [';
                ...
                for($i = 0; $i < count($productos); $i++){
                    ...
                    if($productos[$i]["tipo_producto"] == "Exento"){
...
=============================================*/ 
$activarProductosVentas = new TablaProductosVentasExentas();
$activarProductosVentas -> mostrarTablaProductosVentasExentas();
