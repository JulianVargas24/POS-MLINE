            ...
            <form role="form" method="post" id="form_nueva_matriz">
                ...
                <div class="modal-body">
                    ...
                    <div class="box-body">
                        ...
                        <h4 class="box-title" style="font-weight:bold;margin:auto;margin-bottom:4px;">Datos de
                            matriz</h4>
                        <div class="box box-info">
                            <div class="box-body">
                                <div class="form-group row">
                                    <div class="col-lg-6 col-xs-6">
                                        <div class="d-inline-block text-center"
                                             style="font-size:16px;font-weight:bold;margin-top:10px">Razón social
                                        </div>
                                        <div class="input-group">

                                            <span class="input-group-addon"><i class="fa fa-user"></i></span>

                                            <input type="text" class="form-control input" name="nuevaMatriz"
                                                   id="nuevaMatriz" placeholder="Ingrese razón social" required>

                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-xs-6 ">
                                        <div class="d-inline-block text-center"
                                             style="font-size:16px;font-weight:bold;margin-top:10px">RUT
                                        </div>
                                        <div class="input-group">

                                            <span class="input-group-addon"><i class="fa fa-user"></i></span>

                                            <input type="text" class="form-control input" name="nuevoRut" id="nuevoRut"
                                                   placeholder="Ejemplo: 76948123-5" required>

                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-xs-6">
                                        <div class="d-inline-block text-center"
                                             style="font-size:16px;font-weight:bold;margin-top:10px">País
                                        </div>
                                        <div class="input-group">

                                            <span class="input-group-addon"><i class="fa fa-globe"></i></span>

                                            <input type="text" class="form-control input" name="nuevoPais"
                                                   id="nuevoPais" placeholder="Ingrese país" required value="Chile">
                                    ...
                                    <div class="col-lg-6 col-xs-6">
                                        <div class="d-inline-block text-center"
                                             style="font-size:16px;font-weight:bold;margin-top:10px">Región
                                        </div>
                                        <div class="input-group">

                                            <span class="input-group-addon"><i class="fa fa-globe"></i></span>

                                            <select class="form-control input" id="nuevaRegion" name="nuevaRegion"
                                                    required>
                                    ...
                                    <div class=" col-lg-6 col-xs-6">
                                        <div class="d-inline-block text-center"
                                             style="font-size:16px;font-weight:bold;margin-top:10px">Comuna
                                        </div>
                                        <div class="input-group">

                                            <span class="input-group-addon"><i class="fa fa-map-marker"></i></span>

                                            <select class="form-control input" id="nuevaComuna" name="nuevaComuna"
                                                    required>
                                    ...
                                    <div class="col-lg-6 col-xs-6">
                                        <div class="d-inline-block text-center"
                                             style="font-size:16px;font-weight:bold;margin-top:10px">Dirección
                                        </div>
                                        <div class="input-group">
                                    ...
                                    <div class="col-lg-6 col-xs-6 ">
                                        <div class="d-inline-block text-center"
                                             style="font-size:16px;font-weight:bold;margin-top:10px">Ejecutivo
                                        </div>
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control input" name="nuevoEjecutivo"
                                                   id="nuevoEjecutivo" placeholder="Ingresar ejecutivo" required>

                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="d-inline-block text-center"
                                             style="font-size:16px;font-weight:bold;margin-top:10px">Número de teléfono
                                        </div>
                                        <div class="input-group">
                                            ...
                                            <input type="tel" class="form-control input" name="nuevoTelefono"
                                                   id="nuevoTelefono" placeholder="Ingresar teléfono" required>

                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-xs-6 ">
                                        <div class="d-inline-block text-center"
                                             style="font-size:16px;font-weight:bold;margin-top:10px">Correo electrónico
                                        </div>
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control input" name="nuevoEmail"
                                                   id="nuevoEmail" placeholder="Ingresar correo" required>

                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="d-inline-block text-center"
                                             style="font-size:16px;font-weight:bold;margin-top:10px">Actividad
                                        </div>
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control input" name="nuevaActividad"
                                                   id="nuevaActividad" placeholder="Ingresar actividad" required>
                        ...
                        <div class="box box-success">
                            <div class="box-body">
                                <div class="form-group row">
                                    <div class="col-lg-5 ">
                                        <div class="d-inline-block text-center"
                                             style="font-size:16px;font-weight:bold;margin-top:10px">Fecha inicio de
                                            servicio
                                        </div>
                                        <div class="input-group">
                                            ...
                                            <input type="date" class="form-control input" name="nuevoInicio"
                                                   id="nuevoInicio" required>

                                        </div>
                                    </div>
                                    <div class="col-lg-5 col-xs-offset-1">
                                        <div class="d-inline-block text-center"
                                             style="font-size:16px;font-weight:bold;margin-top:10px">Fecha vcto. de servicio
                                        </div>
                                        <div class="input-group">

                                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span>

                                            <input type="date" class="form-control input" name="nuevoVencimiento"
                                                   id="nuevoVencimiento" required>

                                        </div>
                                    </div>
                                    <div class="col-lg-5">
                                        <div class="d-inline-block text-center"
                                             style="font-size:16px;font-weight:bold;margin-top:10px">Tipo de cliente
                                        </div>
                                        <div class="input-group">

                                            <span class="input-group-addon"><i class="fa fa-envelope"></i></span>

                                            <select class="form-control input" id="nuevoTipoCliente"
                                                    name="nuevoTipoCliente" required>
                                    ...
                                    <div class="col-lg-5 col-xs-offset-1 ">
                                        <div class="d-inline-block text-center"
                                             style="font-size:16px;font-weight:bold;margin-top:10px">Tipo de producto
                                        </div>
                                        <div class="input-group">
                                            ...
                                            <select class="form-control input" id="nuevoTipoProducto"
                                                ...
                                                <option value="POS Basico">POS Básico</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-6 col-xs-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control input" name="editarMatriz"
                                                   id="editarMatriz" required>
                                    ...
                                    <div class="col-lg-6 col-xs-6 ">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control input" name="editarRut"
                                                   id="editarRut" required>
                                    ...
                                    <div class="col-lg-6 col-xs-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control input" name="editarPais"
                                                   id="editarPais" required>
                        ...
                        <div class="box box-success">
                            <div class="box-body">
                                <div class="form-group row">
                                    <div class="col-lg-5 ">
                                        <div class="d-inline-block text-center"
                                             style="font-size:16px;font-weight:bold;margin-top:10px">Fecha inicio
                                            servicio
                                        </div>
                                        <div class="input-group">
                                            ...
                                            <input type="date" class="form-control input" name="editarFechaInicio"
                                                   id="editarFechaInicio" required>
                                    ...
                                    <div class="col-lg-5 col-xs-offset-1">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="date" class="form-control input" name="editarFechaVencimiento"
                                                   id="editarFechaVencimiento" required>

                                        </div>
                                    </div>
                                    <div class="col-lg-5">
                                        <div class="d-inline-block text-center"
                                             style="font-size:16px;font-weight:bold;margin-top:10px">Tipo de campaña
                                        </div>
                                        <div class="input-group">

                                            <span class="input-group-addon"><i class="fa fa-envelope"></i></span>

                                            <select class="form-control input" id="editarTipoCliente"
                                                    name="editarTipoCliente" required>
                                    ...
                                    <div class="col-lg-5 col-xs-offset-1 ">
                                        <div class="d-inline-block text-center"
                                             style="font-size:16px;font-weight:bold;margin-top:10px">Tipo producto
                                        </div>
                                        <div class="input-group">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-6 col-xs-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control input" name="editarMatrizCliente"
                                                   id="editarMatrizCliente" required>
                                    ...
                                    <div class="col-lg-6 col-xs-6 ">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control input" name="editarRutCliente"
                                                   id="editarRutCliente" required>
                                    ...
                                    <div class="col-lg-6 col-xs-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control input" name="editarPaisCliente"
                                                   id="editarPaisCliente" required>
                                    ...
                                    <div class="col-lg-6 col-xs-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select class="form-control input" id="editarRegionCliente"
                                                    name="editarRegionCliente" required>
                                    ...
                                    <div class=" col-lg-6 col-xs-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select class="form-control input" id="editarComunaCliente"
                                                    name="editarComunaCliente" required>
                                    ...
                                    <div class="col-lg-6 col-xs-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control input" name="editarDireccionCliente"
                                                   id="editarDireccionCliente" required>
                                    ...
                                    <div class="col-lg-6 col-xs-6 ">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control input" name="editarEjecutivoCliente"
                                                   id="editarEjecutivoCliente" required>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="tel" class="form-control input" name="editarTelefonoCliente"
                                                   id="editarTelefonoCliente" required>
                                    ...
                                    <div class="col-lg-6 col-xs-6 ">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control input" name="editarEmailCliente"
                                                   id="editarEmailCliente" required>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control input" name="editarActividadCliente"
                                                   id="editarActividadCliente" required>
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-5 ">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="date" class="form-control input" name="editarInicioCliente"
                                                   id="editarInicioCliente" readonly required>

                                        </div>
                                    </div>
                                    <div class="col-lg-5 col-xs-offset-1">
                                        <div class="d-inline-block text-center"
                                             style="font-size:16px;font-weight:bold;margin-top:10px">Fecha vcto. servicio
                                        </div>
                                        <div class="input-group">
                                            ...
                                            <input type="date" class="form-control input"
                                                   name="editarVencimientoCliente" id="editarVencimientoCliente"
                                                   readonly required>
                                    ...
                                    <div class="col-lg-5">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select class="form-control input" id="editarTipoClienteCliente"
                                                    name="editarTipoClienteCliente" disabled required>
                                    ...
                                    <div class="col-lg-5 col-xs-offset-1 ">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select class="form-control input" id="editarTipoProductoCliente"
                                                    name="editarTipoProductoCliente" required>
