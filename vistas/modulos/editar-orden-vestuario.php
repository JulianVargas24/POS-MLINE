  ...
  <section class="content-header">
    ...
    <section class="content">
                ...
                <form role="form" method="post" class="formularioOrdenVestuario">
                    ...
                    <div class="row">
                                        ...
                                        <div class="row" style="margin-bottom:5px;">
                                            <div class="col-xs-12">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="hidden" name="idOrdenVestuario" id="idOrdenVestuario" value="<?php echo $ordenVestuario["id"];?>">                
                                            ...
                                            <div class="col-xs-6">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" id="traerRutVestuario" value="" readonly >
                                                        </div>
                                                    </div> 
                                            </div>
                                            <div class="col-xs-6">                                                  
                                            ...
                                            <div class="col-xs-6">   
                                                    <div class="form-group">
                                                        <div class="input-group">   
                                                            ...
                                                            <input type="text" class="form-control" id="traerActividadVestuario" value="" readonly>
                                                        </div>
                                                    </div> 
                                            </div>
                                            <div class="col-xs-6">                                  
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control" id="traerEjecutivoVestuario" value="" readonly>
                                                        </div>
                                                    </div> 
                                            </div>
                                            <div class="col-xs-6">                                                  
                                            ...
                                            <div class="col-xs-6">
                                                    <div class="form-group">
                                                        ...
                                                        <span class="input-group-addon"> <i class="fa fa-at"></i> Correo</span>                
                                                            <input type="text" class="form-control" id="traerEmailVestuario" value="" readonly>
                                                        </div>
                                                    </div> 
                                            </div>
                        ...
                        <div class="col-xs-3">
                           <div class="box box-info">
                                <div class="box-body">
                                    <h4 class="box-title" style="color:#39b616;font-weight:bold; font-size:21px; color:green;"> ORDEN DE VESTUARIO</h4>
                                        <div class="row" style="margin-top:2px;">
                                            <div class="col-xs-7">
                                                 <div class="form-group">
                                                        <div class="input-group">
                                                        <span class="input-group-addon" style="background-color:red; color:white; font-weight:bold">FOLIO</span>
                                                            <input type="text" style="font-weight:bold; font-size:16px;" class="form-control" name="nuevoCodigo" id="nuevoCodigo" value="<?php echo $ordenVestuario["codigo"]; ?>" readonly required>
                                                        </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="row nuevoPersonal">
                        ...
                        <?php
                                            ...
                                            foreach ($listaProducto as $key => $value) {
                                                ...
                                                <button type="button"  idPersonal="'.$value["id"].'" data-dismiss="modal" class="btn btn-info btnEditarMedidasPersonal">Mostrar</button>
        ...
        <div class="box box-warning">
                        ...
                        <textarea name="nuevaObservacion" id="nuevaObservacion" cols="60" rows="6"><?php echo $ordenVestuario["observacion"];?></textarea>
                        <h4>Subir Archivo</h4>
