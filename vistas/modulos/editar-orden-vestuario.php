                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-3">
                            <div class="box box-info">
                                <div class="box-body">
                                    <h4 class="box-title"
                                        style="color:#39b616;font-weight:bold; font-size:21px; color:green;"> ORDEN DE VESTUARIO</h4>
                                        ...
                                        <div class="col-xs-10">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" style="font-weight:bold; font-size:16px;" class="form-control" name="nuevoNombreOrden" id="NombreOrden" value="<?php echo $ordenVestuario['nombre_orden']; ?>" required>
                                                </div>
                                            </div>
                                        </div>
