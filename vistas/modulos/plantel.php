                  ...
                  <div class="col-xs-6">
                    ...
                    <div class="input-group">
                      ...
                      <span class="input-group-addon"><i class="fa fa-calculator"></i></span>
                        ...
                        <input type="number" class="form-control input" name="nuevaComision" id="nuevaComision" placeholder="Ingrese Comisión" min="0" max="100" step="0.01" required>
                  ...
                  <div class="col-xs-6">
                    ...
                    <div class="input-group">
                      ...
                      <span class="input-group-addon"><i class="fa fa-calculator"></i></span>
                        ...
                        <input type="number" class="form-control input" name="editarComision" id="editarComision" placeholder="Ingrese Comisión" min="0" max="100" step="0.01" required>
