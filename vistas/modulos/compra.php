                        ...
                        <div class="col-xs-3">
                           <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <h4 class="box-title" style="color:#39b616;font-weight:bold; font-size:21px; color:red;"> FACTURA DE COMPRA</h4>
                                        <div class="row" style="margin-top:2px;">
                                            <div class="col-xs-7">
                                                 <div class="form-group">
                                                        <div class="input-group">
                                                        <span class="input-group-addon" style="background-color:red; color:white; font-weight:bold">FOLIO</span>
                                                            <input type="hidden" name="nuevoFolioOC" id="nuevoFolioOC" value="0">
