...
<div class="content-wrapper">
  ...
  <h1 style="color:green;font-weight:bold">
    ...
    <section class="content">
        <div class="box">
            <div class="box-body">
                <form role="form" method="post" class="formularioFacturaExenta">
                <!--=====================================
                                        ...
                                        <div class="box box-info">
                                                <div class="box-body">
                                                    <h4 class="box-title" style="font-weight:bold; font-size:20px;">Datos de Emisión</h4>
                                                        ...
                                                        <div class="col-xs-6"> <!-- Abre el primer div -->
                                                            <div class="d-block" style="font-size:14px;">Fecha Emisión</div> <!-- Abre y cierra el segundo div -->
                                                            <div class="form-group"> <!-- Abre el tercer div -->
                                                                <div class="input-group"> <!-- Abre el cuarto div -->
                                                                    <input type="date" class="form-control input-sm" name="nuevaFechaEmision" id="nuevaFechaEmision" 
                                                                    value="<?php echo date('Y-m-d'); ?>" required 
                                                                    onchange="validarFechas(this.id, 'nuevaFechaVencimiento')"> <!-- Input correctamente cerrado -->
                                                                </div> <!-- Cierra el cuarto div -->
                                                            </div> <!-- Cierra el tercer div -->
                                                        </div> <!-- Cierra el primer div -->
                        ...
                        <div class="col-xs-4">
                           <div class="box box-info">
                                <div class="box-body">
                                                        ...
                                                        $atributo= "boleta_exenta";
                                                        $folio = ModeloParametrosDocumentos::mdlMostrarFolio($tabla, $atributo);
                                                        ?>
                                        <h4 class="box-title" style="color:#39b616;font-weight:bold; font-size:21px; color:red" id="tipodte">BOLETA EXENTA</h4>
                                        <div class="row">
                                            <div class="col-xs-5">
                                                 <div class="form-group">
                                                        <div class="input-group">
                                        ...
                                        <div class="box-body">
                                                ...
                                                <div class="row">
                                                            ...
                                                            <div class="col-xs-7">
                                                                    <div class="form-group">
                                                                        <div class="input-group">
                                                                            <span class="input-group-addon" style="padding:0px 2px">Subtotal</span>                
                                            ...
                                            <div class="box box-success">
                                                <div class="box-header with-border"></div>
                                                    <div class="box-body">
                                                        ...
                                                        <table  class="table table-bordered table-striped dt-responsive tablaVentaBoletaExenta">
