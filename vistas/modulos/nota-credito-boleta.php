...
<div class="content-wrapper">
  ...
  <h1 style="color:green;font-weight:bold">
      ...
      NOTA DE CREDITO DE BOLETA AFECTA
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Nota de Credito de Boleta Afecta</li>
        ...
        <div class="box">
            <div class="box-body">
                ...
                <?php
                        ...
                        $venta = ControladorVentas::ctrMostrarVentasBoletas($item, $valor);
                ...
                FECHAS Y TIPO DE DOCUMENTO
                        ...
                        <div class="col-xs-3">
                           <div class="box box-info">
                                <div class="box-body">
                                        ...
                                        ?>
                                         <h4 class="box-title" style="color:#39b616;font-weight:bold; font-size:21px; color:green;">NOTA DE CREDITO</h4>
                                        ...
                                        <h4 class="box-title" style="color:#39b616;font-weight:bold; font-size:21px; color:red;"> BOLETA AFECTA</h4>
                                        <div class="row" style="margin-top:2px;">
                                            <div class="col-xs-7">
                                                 <div class="form-group">
                                                        <div class="input-group">
                                                        <span class="input-group-addon" style="background-color:red; color:white; font-weight:bold">FOLIO</span>
                                                            <input type="text" style="font-weight:bold; font-size:16px;" class="form-control" name="codigoBoleta" id=codigoBoleta" value="<?php echo $venta["codigo"]; ?>" readonly required>
                                                        </div>
                    ...
                    <button type="submit" class="btn btn-primary">Guardar Nota Credito</button>     
                        </div>
...
$agregarNotaCredito -> ctrCrearNotaCreditoBoleta();
