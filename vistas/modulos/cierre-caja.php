            ...
            <div class="box-body">
                <form role="form" method="post">
                    <div class="row">
                        ...
                        <div class="col-lg-2">
                            <input class="btn btn-primary btnGenerarCierre" style="margin-top:20px;" value="CONSULTAR"
                                   readonly/>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="box-body">
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-xs-6">
                                                        <div class="d-inline-block  text-center"
                                                             style="font-size:16px;font-weight:bold">Encargado
                                                        </div>
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control input"
                                                                   ...
                                                                   placeholder="Nombre de Encargado" readonly>
                                        ...
                                        <div class="box box-success">
                                            <div class="box-title">
                                                <h4 style="font-weight:bold">VENTAS DEL DÍA</h4>
                                            </div>
                                            <div class="box-body">
                                                <div class="form-group row">
                                                    <div class="col-xs-12">
                                                        <table class="table table-bordered table-striped dt-responsive"
                                                            ...
                                                            <tr>
                                                                <td style="font-weight:bold;font-size:16px;">Cantidad
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td style="font-weight:bold;font-size:16px;">Contado
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td style="font-weight:bold;font-size:16px;">Crédito
                                                                </td>
                                                                ...
                                                                <td>
                                                                    $ <?php echo number_format($sumaPendiente, 0) ?></td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    $ <?php echo number_format($sumaTotalFinal, 0) ?></td>
                                                            </tr>
                                                        </table>
                                                    </div>
                        ...
                        <div class="box box-success">
                            ...
                            <div class="box-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-xs-4">
                                        <div class="d-inline-block text-left" style="font-size:22px;">Nota de crédito
                                        </div>
                                    </div>
                                    <div class="col-xs-2 col-xs-offset-6">
                                        <div class="d-inline-block text-center" style="font-size:22px;">${cantidad}
                        ...
                        <div class="box box-warning">
                            ...
                            <div class="box-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-xs-4">
                                        <div class="d-inline-block text-left" style="font-size:22px;">Nota débito</div>
                                    </div>
                                    <div class="col-xs-2 col-xs-offset-6">
                                        <div class="d-inline-block text-center" style="font-size:22px;">${cantidad}
                                        </div>
