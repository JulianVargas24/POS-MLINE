    ...
    <section class="content">
        ...
        <div class="box" style="width: 100%;">
            ...
            <div class="box-header with-border">
                <div>
                    <strong style="font-size: 15px;"> Cliente: <input type="text" class="form-group"
                ...
                <div>
                    <strong style="font-size: 15px;"> Vendedor: <input type="text" class="form-group"
                ...
                <div style="text-align: right; position:relative; bottom:70px; color:red;">
                    <strong style="font-size: 16px;">Código Factura:<input type="text" class="form-group" size="2"
                    ...
                    <div class="col-md-4">
                        <div style="width: fit-content">
                            <table class="table table-bordered dt-responsive" width="100%">
                                ...
                                foreach ($listaProducto as $key => $value) {
                                    ...
                                    <tr>
                                        <td><input type="text" class="form-control"
                                                   value="<?php echo $value["descripcion"] ?>" disabled
                                                   style="border: none; background-color:white;"></td>
                                        <td><input type="text" class="form-control"
                                                   value="<?php echo $value["cantidad"] ?>" disabled
                                                   style="border: none; background-color:white;"></td>
                                        <td><input type="text" class="form-control"
                                                   value="<?php echo "$ " . number_format($value["precio"], 0) ?>"
                                                   disabled style="border: none; background-color:white;"></td>
                                        <td><input type="text" class="form-control"
                                                   value="<?php echo "$ " . number_format($value["total"], 0) ?>"
                                                   disabled style="border: none; background-color:white;"></td>
                                    </tr>
                                ...
                                <tr>
                                    <td colspan="3"><input type="text" class="form-control" value="SUB TOTAL:"
                                                           style="text-align: right; font-weight:bold; border: none; background-color:white;"
                                                           disabled readonly></td>
                                    <td><input type="text" class="form-control" size="5"
                                               value="<?php echo " $" . number_format($venta["neto"], 0) ?>" disabled
                                               style="border: none; background-color:white;"></td>
                                </tr>
                                </tbody>
                            </table>
