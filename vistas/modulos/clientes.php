        ...
        <div class="box">
            ...
            <div class="box-header with-border">
                ...
                <a href="vistas/modulos/descargar-reporte-clientes.php?reporte=reporte">
                    <button class="btn btn-success">Descargar reporte de clientes en Excel</button>
                </a>
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control input" name="nuevoCliente"
                                                   id="nuevoCliente" placeholder="Ingrese razón social" required>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="d-inline-block  text-center"
                                             style="font-size:16px;font-weight:bold">Actividad
                                        </div>
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-th"></i></span>
                                            <input type="text" class="form-control input" name="nuevaActividad"
                                                   id="nuevaActividad" placeholder="Ingrese su actividad" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-6">
                                        <div class="d-inline-block text-center "
                                             style="font-size:16px;font-weight:bold">Región
                                        </div>
                                        <div class="input-group">
                                    ...
                                    <div class="col-xs-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select class="form-control input" id="nuevoFactor" name="nuevoFactor"
                                                    required>
                        ...
                        <div class="box box-warning">
                            <div class="box-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-xs-4">
                                        <div class="d-block" style="font-size:16px;font-weight:bold">Número de
                                            teléfono
                                        </div>
                                        <div class="input-group">
                                    ...
                                    <div class="col-xs-4">
                                        <div class="d-block" style="font-size:16px;font-weight:bold">Correo
                                            electrónico
                                        </div>
                                        <div class="input-group">
                        ...
                        <div class="box box-success">
                            <div class="box-body">
                                <div class="form-group row">
                                    <div class="col-xs-4">
                                        <div class="d-inline-block  text-center"
                                             style="font-size:16px;font-weight:bold">Plazo de Pago
                                        </div>
                                        <div class="input-group">

                                            <span class="input-group-addon"><i class="fa fa-code"></i></span>

                                            <select class="form-control input" id="nuevoPlazo" name="nuevoPlazo"
                                                    required>
                                    ...
                                    <div class="col-xs-4">
                                        <div class="d-inline-block  text-center"
                                             style="font-size:16px;font-weight:bold">Vendedor
                                        </div>
                                        <div class="input-group">

                                            <span class="input-group-addon"><i class="fa fa-check"></i></span>

                                            <select class="form-control input" id="nuevoVendedor" name="nuevoVendedor"
                                                    required>
                                    ...
                                    <div class="col-xs-4">
                                        <div class="d-inline-block  text-center"
                                             style="font-size:16px;font-weight:bold">Estado de cliente en sistema
                                        </div>
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-check"></i></span>

                                            <select class="form-control input" id="nuevoEstado" name="nuevoEstado"
                                                    required>
                                ...
                                <div class="form-group row">
                                    <div class="col-xs-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="tel" class="form-control input" name="nuevoTelefonoCobranza"
                                                   placeholder="Ingresar contacto" required>

                                        </div>
                                    </div>
                                    <div class="col-xs-4 ">
                                        <div class="d-block text-center" style="font-size:16px;font-weight:bold">Correo
                                            electrónico
                                        </div>
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control input" name="nuevoEmailCobranza"
                                                   placeholder="Ingresar correo" required>

                                        </div>
                                    </div>
                                    <div class="col-xs-4">
                                        <div class="d-block text-center" style="font-size:16px;font-weight:bold">Fono
                                        </div>
                                        <div class="input-group">

                                            <span class="input-group-addon"><i class="fa fa-phone"></i></span>

                                            <input type="text" class="form-control input" name="nuevoFonoCobranza"
                                                   placeholder="Ingresar fono" required>
                                ...
                                <div class="form-group row">
                                    <div class="col-xs-3">
                                        <div class="d-block text-center" style="font-size:16px;font-weight:bold;">Línea
                                            de crédito
                                        </div>
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control input" name="nuevaLinea"
                                                   placeholder="Ingresar línea de crédito" required>

                                        </div>
                                    </div>
                                    <div class="col-xs-3">
                                        <div class="d-block text-center" style="font-size:16px;font-weight:bold">Bloqueo
                                            para crédito
                                        </div>
                                        <div class="input-group">
                                    ...
                                    <div class="col-xs-6">
                                        ...
                                        <textarea style="border-width:1px;border-color:blue" class="form-control input"
                                                  name="" id="" cols="6" rows="3"></textarea>
                                    </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control input" name="editarCliente"
                                                   id="editarCliente" placeholder="Ingrese razón social" required>
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control input" name="editarRutId"
                                                   id="editarRutId" placeholder="Ingrese su RUT" required>
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control input" name="editarActividad"
                                                   id="editarActividad" placeholder="Ingrese su actividad" required>
                                        </div>
                                    </div>
                                    <!-- ENTRADA PARA LA SUBCATEGORIA -->
                                    <div class="col-xs-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control input" name="editarPais"
                                                   id="editarPais" placeholder="Ingrese país" required value="Chile">
                                    ...
                                    <div class="col-xs-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select class="form-control input" id="editarFactor" name="editarFactor"
                                                    required>
                                    ...
                                    <div class="col-xs-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control input" name="editarEmail"
                                                   id="editarEmail" placeholder="Ingresar correo" required>
                                ...
                                <div class="form-group row">
                                    <div class="col-xs-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select class="form-control input" id="editarPlazo" name="editarPlazo"
                                                    required>
                                    ...
                                    <div class="col-xs-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select class="form-control input" id="editarVendedor" name="editarVendedor"
                                                    required>
