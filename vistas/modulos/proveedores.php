                      ...
                      <div class="col-xs-6">
                        ...
                        Razon Social
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control input" name="nuevoProveedor" id="nuevoProveedor" placeholder="Ingresar Razon Social" required>
                      ...
                      <div class="col-xs-6">
                        <div class="d-inline-block text-center" style="font-size:16px;font-weight:bold">RUT</div>
                          <div class="input-group">
                            ...
                            <input type="text"  class="form-control input" name="nuevoRutId" id="nuevoRutId" placeholder="Ingresar Rut">
                      ...
                      <div class="col-xs-6">
                          <div class="d-block text-center" style="font-size:16px;font-weight:bold">Actividad</div>  
                            <div class="input-group">
                              ...
                              <input type="text"  class="form-control input" name="nuevaActividad" id="nuevaActividad" placeholder="Ingrese Actividad">
                      ...
                      <div class="col-xs-6">
                          <div class="d-block text-center" style="font-size:16px;font-weight:bold">Linea de Credito</div>
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control input"  placeholder="Ingresar Linea de Credito" required>
                      ...
                      <div class="col-xs-6">
                          <div class="d-block text-center" style="font-size:16px;font-weight:bold">Actividad</div>  
                            <div class="input-group">
                              ...
                              <input type="text"  class="form-control input" name="editarActividad" id="editarActividad" placeholder="Ingrese Actividad">
                      ...
                      <div class="col-xs-6">
                        <div class="d-inline-block text-center " style="font-size:16px;font-weight:bold">Pais</div>
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control input" name="editarPais" id="editarPais" value="Chile" required>
                      ...
                      <div class="col-xs-6">
                          <div class="d-block text-center" style="font-size:16px;font-weight:bold">Linea de Credito</div>
                            <div class="input-group">
                              ...
                              <input type="text" class="form-control input" name="editarLinea" id="editarLinea" value="0" required>
