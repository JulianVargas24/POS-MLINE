...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li>Ventas</li>
            <li class="active">Cotización exenta</li>
        ...
        <div class="box">
            <div class="box-body">
                <form role="form" method="post" class="formularioCotizacionExenta">
                        ...
                        <div class="col-xs-3">
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    $atributo = "cotizacion_exenta";
                                    $folio = ModeloParametrosDocumentos::mdlMostrarFolio($tabla, $atributo);

                                    ?>
                                    <h4 class="box-title"
                                        style="color:#39b616;font-weight:bold; font-size:21px;color:red;"> COTIZACIÓN
                                        EXENTA</h4>
                    ...
                    <button type="submit" class="btn btn-primary">Guardar cotización exenta</button>
