        ...
        <div class="box">
            <div class="box-body">
                ...
                <?php
                        ...
                        $venta = ControladorVentas::ctrMostrarVentasBoletasExentas($item, $valor);
                        ...
                        <div class="col-xs-3">
                           <div class="box box-info">
                                <div class="box-body">
                                        ...
                                        <h4 class="box-title" style="color:#39b616;font-weight:bold; font-size:21px; color:red;"> BOLETA EXENTA</h4>
                                        <div class="row" style="margin-top:2px;">
                                            <div class="col-xs-7">
                                                 <div class="form-group">
                                                        <div class="input-group">
