    ...
    <div class="box">
      ...
      <div class="box-header with-border">
          <a href="vistas/modulos/descargar-reporte-productos.php?reporte=reporte">
            <button class="btn btn-success">Descargar Reporte Productos en Excel</button>
          </a>
          ...
          <div class="box-body">
            ...
            <div class="box box-info">
              <div class="box-body">
                ...
                <div class="form-group row">
                    <div class="col-xs-6">
                        <div class="d-inline-block  text-center" style="font-size:16px;font-weight:bold">Categoría</div>
                        <div class="input-group">
                          <span class="input-group-addon"><i class="fa fa-th"></i></span> 
            ...
            <div class="box box-danger"> 
              <div class="box-body">
                <div class="form-group row">
                      <input type="hidden" class="form-control input" id="nuevaBodega" name="nuevaBodega" value="1" required>
                      <input type="hidden" class="form-control input" name="nuevoStock" min="0" placeholder="Stock" value="0" required>
                  ...
                  <div class="d-inline-block  text-center" style="font-size:16px;font-weight:bold">Stock Mínimo</div>
                    <div class="input-group">
                      ...
                      <input type="number" class="form-control input" name="nuevoStockMin" min="0" placeholder="Stock Mínimo" required>
            ...
            <div class="box box-success">
              <div class="box-body">
                <div class="form-group row"> 
                  ...
                  <div class="col-xs-4">
                      <div class="d-inline-block  text-center" style="font-size:16px;font-weight:bold">Afecto/Exento</div> 
                        <div class="input-group">
                  ...
                  <div class="col-xs-4">
                    <div class="d-inline-block  text-center" style="font-size:16px;font-weight:bold;margin-top:10px;">Tabla Lista</div>
                    <div class="input-group">
                      <span class="input-group-addon"><i class="fa fa-check"></i></span> 

                      <select class="form-control input" id="nuevaTablaLista" name="nuevaTablaLista" >
                  ...
                  <div class="col-xs-4">
                    <div class="d-inline-block  text-center" style="font-size:16px;font-weight:bold;margin-top:10px;">Impuestos Adicionales</div>
                    <div class="input-group">
                      <span class="input-group-addon"><i class="fa fa-check"></i></span> 
            ...
            <div class="box box-info">
              <div class="box-body">
                ...
                <div class="form-group row">
                  ...
                  <!-- ENTRADA PARA LA SUBCATEGORIA -->                           
                    <div class="col-xs-6">
                      <div class="d-inline-block  text-center" style="font-size:16px;font-weight:bold">Subcategoría</div>
                        <div class="input-group">
            ...
            <div class="box box-danger"> 
              <div class="box-body">
                <div class="form-group row">
                      ...
                      <input type="hidden" class="form-control input" id="editarStock" name="editarStock" min="0" placeholder="Stock" readonly required>
                     <input type="hidden" class="form-control input" id="editarBodega" name="editarBodega" required>     
                  ...
                  <div class="d-inline-block  text-center" style="font-size:16px;font-weight:bold">Stock Mínimo</div>
                    <div class="input-group">
                      ...
                      <input type="number" class="form-control input" id="editarStockMin" name="editarStockMin" min="0" placeholder="Stock Mínimo" required>
                ...
                <div class="form-group row"> 
                  ...
                  <div class="col-xs-4">
                    ...
                    <div class="input-group">
                      ...
                      <select class="form-control input" id="editarTablaLista" name="editarTablaLista" >
