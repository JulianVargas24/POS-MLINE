...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Editar Cotización Exenta</li>
    ...
    <section class="content">
        <div class="box">
            ...
            $editarCotizacionExenta = new ControladorCotizacion();
            $editarCotizacionExenta->ctrEditarCotizacionExenta();
