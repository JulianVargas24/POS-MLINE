...
require_once "../../controladores/venta-factura.controlador.php";
require_once "../../modelos/venta-factura.modelo.php";
...
$reporte = new ControladorVentaFactura();
$reporte -> ctrDescargarReporteVentaAfecta();