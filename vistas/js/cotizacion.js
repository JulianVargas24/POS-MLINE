...
$(".tablaCotizacion tbody").on("click", "button.agregarProducto", function () {
  ...
  $.ajax({
    ...
    success: function (respuesta) {
      ...
      $(".nuevoTotalProducto").number(true);
...
$(document).ready(function () {
  ...
  var idLista = $("option:selected", $("#nuevoClienteCotizacion")).attr(
    "idLista"
  );
  var datos = new FormData();
...
$(".tablas").on("click", ".btnFacturarCotizacionAfecta", function () {
  var idCotizacion = $(this).attr("idCotizacion");

  window.location =
    "index.php?ruta=facturacion-afecta&idCotizacion=" + idCotizacion;
});

$(".tablas").on("click", ".btnFacturarCotizacionExenta", function () {
  var idCotizacion = $(this).attr("idCotizacion");

  window.location =
    "index.php?ruta=facturacion-exenta&idCotizacion=" + idCotizacion;
});
...
$(".tablas").on("click", ".btnImprimirCotizacionAfecta", function () {
  var codigoCotizacion = $(this).attr("codigoCotizacion");
  var tipoDocumento = "Cotizacion_Afecta";
...
$(".tablas").on("click", ".btnImprimirCotizacionExenta", function () {
  var codigoExenta = $(this).attr("codigoCotizacion");
  var tipoDocumento = "Cotizacion_Exenta";
