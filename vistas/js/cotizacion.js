...
$(".tablas").on("click", ".btnFacturarCotizacionAfecta", function(){
	...
	window.location = "index.php?ruta=facturacion-afecta&idCotizacion="+idCotizacion;
...
$(".tablas").on("click", ".btnFacturarCotizacionExenta", function(){
	...
	window.location = "index.php?ruta=facturacion-exenta&idCotizacion="+idCotizacion;
...
$(".tablas").on("click", ".btnImprimirCotizacionAfecta", function(){
	...
	window.open("extensiones/tcpdf/pdf/documento.php?codigo="+codigoCotizacion + "&documento="+tipoDocumento , "_blank"); 
...
$(".tablas").on("click", ".btnImprimirCotizacionExenta", function(){
	...
	window.open("extensiones/tcpdf/pdf/documento.php?codigo="+codigoExenta + "&documento="+tipoDocumento , "_blank"); 
