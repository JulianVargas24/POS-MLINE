...
$(".tablaVentaBoletaExenta tbody").on("click", "button.agregarProducto", function(){
			  ...
			  '</div>' +
				...
				'<!-- Subtotal Neto -->'+
					...
					'<!-- Precio Total Neto del producto -->'+
					    ...
					    '<input   type="hidden" class="form-control nuevoPrecioProducto" onchange="cambios()" precioReal="'+precio+'" name="nuevoPrecioProducto" value="'+total_neto+'" readonly required>'+

							
						'<input type="hidden" class="form-control nuevoIvaProducto" style="padding:5px" name="nuevoIvaProducto" min="0" value="'+impuesto+'"  readonly required>'+
...
$(".formularioFacturaExenta").on("change", "select.nuevaDescripcionProducto", function(){
...
=============================================*/
$(".formularioFacturaExenta").on("change", "input.nuevoPrecioUnitario", function(){
...
$(".formularioFacturaExenta").on("change", "input.nuevaCantidadProducto", function(){
...
$(".formularioFacturaExenta").on("change", "input.nuevoDescuentoProducto", function(){
	var preciou = $(this).parent().parent().children(".precioUnitario").children(".nuevoPrecioUnitario");
	var precio = $(this).parent().parent().children(".ingresoPrecio").children(".nuevoPrecioProducto");
	var cantidad = $(this).parent().parent().children(".cantidadProducto").children(".nuevaCantidadProducto");
	var iva = $(this).parent().parent().children(".ivaProducto").children(".nuevoIvaProducto");
